...
<?php include 'nav.php' ?>
    ...
    <main class="mb-5 pb-5 mb-md-0">
        ...
        <h1 class="mb-3">Usuario Inexistente</h1>
        <hr>
        <div class="row">
        <div class="form-group col-12">
        <p class="mt-2">Usuario digitado não localizado, ninguem vai ler mensagem de erro, então estou escrevendo qualquer coisa. Tente novamente ou cadastre-se.</p>
        <a href="./login.php" class="mt-4 btn btn-danger paddin">voltar a pagina de login</a>
        <p class="mt-3">
