...
<?php include 'nav.php' ?>
    ...
    <main class="mb-5 pb-5 mb-md-0">
        ...
        <h1 class="mb-3">Cadastro já existente</h1>
        <hr>
        <div class="row">
        <div class="form-group col-12">
        <p class="mt-2">Usuario digitado já localizado, ninguem vai ler mensagem de erro, então estou escrevendo qualquer coisa. deseja fazer login.</p>
        <a href="./login.php" class="mt-4 btn btn-danger paddin">Ir para pagina de login</a>
        <p class="mt-3">
